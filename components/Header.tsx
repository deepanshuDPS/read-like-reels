        ...
        { pathname != "/" && <>
          ...
          <div className={`${isMenuOpen ? 'block' : 'hidden'
            ...
            <ul className={"text-lg font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 bg-transparent"}>
              <li>
                <Link href="..?type=quote" className={"block py-2 px-3 rounded md:p-0 md:hover:text-blue-700 "} >Quotes</Link>
              </li>
              <li>
                <Link href="..?type=poem" className={"block py-2 px-3 rounded md:p-0 md:hover:text-blue-700  "} >Poems</Link>
              </li>
              <li>
                <Link href="..?type=paragraph" className={"block py-2 px-3 rounded md:p-0 md:hover:text-blue-700  "} >Paragraphs</Link>
              </li>
              <li>
                <Link href="..?type=story" className={"block py-2 px-3 rounded md:p-0 md:hover:text-blue-700  "}  >Stories</Link>
              </li>
              <li>
                <Link href="..?type=eassy" className={"block py-2 px-3 rounded md:p-0 md:hover:text-blue-700  "} >Essays</Link>
              </li>
            </ul>
          </div>
        </>}
