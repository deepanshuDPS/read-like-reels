...
import { getUserName, getUserPic } from "@/utils/helpers";
...
export default async function MyProfile() {
  ...
  return (
    <div className="flex-1 w-full flex flex-col  px-8 pt-24 pb-8">
      <div className="bg-white rounded-lg shadow-xl pb-8">
        ...
        <div className="flex flex-col items-center -mt-20">
          <ImageSrc url={getUserPic(user)} classes="w-40 h-40 border-4 border-white rounded-full bg-white-500" />
          <div className="flex items-center space-x-2 mt-2">
            <p className="text-2xl">{getUserName(user)}</p>
